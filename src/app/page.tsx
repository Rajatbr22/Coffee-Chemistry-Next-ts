...
import CoffeeBlast from '@/public/images/coffee_blast.png'
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-20 px-4 md:px-6 max-w-full relative">
        ...
        <div className="flex justify-center items-center mb-8">
          <h2 className="text-2xl md:text-5xl font-bold font-playfair mb-4">Top Products</h2>
        </div>
        ...
        <div className="text-center mt-20 relative z-10">
          <Link href="/products" className="text-[#1E1E1E] hover:text-coffee bg-[#F9C06A] text-2xl font-bold border-2 py-2 px-10 md:py-2 md:px-14 md:text-4xl rounded-xl font-playfair">
            View All
          </Link>
        </div>
      </section>
      ...
      <div className="absolute right-0 md:h-2/3 md:w-1/3 h-1/2 w-2/3 overflow-hidden pointer-events-none md:z-0 md:-mt-96 mt-32">
          <Image
            src={CoffeeBlast}
            alt="coffee blast"
            height={500}
        ...
        <div className="max-w-7xl md:mx-auto mx-2 flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-1/2 font-playfair">
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-[#603809]">Discover the best coffee</h2>
            ...
            <Button asChild className="bg-[#F9C06A] hover:bg-coffee text-black hover:text-white rounded-full">
      ...
      <section className="py-10 px-4 md:px-6 max-w-full relative">
        ...
        {/* Section Heading */}
        <div className="flex justify-center items-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold font-playfair">Categories</h2>
        </div>
      ...
      <section className="py-8 md:py-12 px-4 sm:px-6 md:max-w-7xl mx-auto font-playfair">
        <h2 className="text-4xl sm:text-4xl md:text-5xl font-bold text-center text-coffee">Why are we different?</h2>
        <p className="text-center mt-2 md:mt-4 text-[#707070] px-4 sm:text-base">We don't just make your coffee, we make your day!</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-xs sm:max-w-xl lg:max-w-5xl xl:max-w-6xl">
          ...
          <div className="flex flex-col items-center text-center bg-[#FFEED8] py-8 px-6 md:py-10 md:px-6 lg:py-12 lg:px-8 w-full">
            ...
            <h3 className="font-bold text-xl sm:text-2xl mb-1 md:mb-2 text-coffee-light">Supreme Beans</h3>
            <p className="text-gray-600 text-sm sm:text-base">Beans that provides great taste</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center bg-[#FFF9F1] border-2 border-[#FFEED8] py-8 px-6 md:py-10 md:px-6 lg:py-12 lg:px-8 w-full">
            ...
            <h3 className="font-bold text-xl sm:text-2xl mb-1 md:mb-2 text-coffee-light">High Quality</h3>
            <p className="text-gray-600 text-sm sm:text-base">We provide the highest quality</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center bg-[#FFF9F1] border-2 border-[#FFEED8] py-8 px-6 md:py-10 md:px-6 lg:py-12 lg:px-8 w-full">
            ...
            <h3 className="font-bold text-xl sm:text-2xl mb-1 md:mb-2 text-coffee-light">Extraordinary</h3>
            <p className="text-gray-600 text-sm sm:text-base">Coffee like you have never tasted</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center bg-[#FFF9F1] border-2 border-[#FFEED8] py-8 px-6 md:py-10 md:px-6 lg:py-12 lg:px-8 w-full">
            ...
            <h3 className="font-bold text-xl sm:text-2xl mb-1 md:mb-2 text-coffee-light">Affordable Price</h3>
            <p className="text-gray-600 text-sm sm:text-base">Our Coffee prices are easy to afford</p>
          </div>
        </div>
        </div>

        <p className="text-center mt-8 md:mt-10 text-[#707070] px-4 sm:text-base">Great ideas start with great coffee, Lets help you achieve that</p>
        <h2 className="text-2xl md:text-3xl mt-2 font-bold text-center text-coffee">Get started today.</h2>
      </section>
      ...
      <section className="py-10 md:py-16 px-4 md:px-6 text-white relative font-playfair">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-20 pt-1 md:pt-0">
          ...
          <h2 className="text-2xl md:text-4xl font-bold mb-2 md:mb-4 relative">Subscribe to get the Latest News</h2>
          <p className="text-sm md:text-base mb-4 md:mb-6 relative">Don't miss out on our latest news, updates, tips and special offers</p>
